...
async function scrapeTerms() {
  ...
  try {
    ...
    await page.goto('https://diravena.com/policies/terms-of-service', { waitUntil: 'networkidle2', timeout: 30000 });
    ...
    const data = { scrapedAt: new Date().toISOString(), source: 'https://diravena.com/policies/terms-of-service', type: 'terms-of-service', data: termsData };
    const outputPath = path.join(__dirname, '..', 'data', 'diravena-terms.json');
